...
* **litespi/phy/generic_sdr**                       : Fixed SDR `no_read`, SPI mode reset/default handling, and clock-generator start/reset corner cases ([PR #96](https://github.com/enjoy-digital/litespi/pull/96), [PR #97](https://github.com/enjoy-digital/litespi/pull/97)).
...
* **litespi/modules**                               : Added W25Q128JW flash support ([PR #98](https://github.com/enjoy-digital/litespi/pull/98)).
...
* **litespi/phy/generic_sdr / core**                : Reworked SDR clock divider generation, chip-select timing, and per-core divider selection for better SDR/DDR compatibility ([PR #95](https://github.com/enjoy-digital/litespi/pull/95)).
