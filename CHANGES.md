...
* **litex/soc/software/bios**                       : Fixed and hardened boot JSON parsing, including malformed-token handling and JSON token helper availability when Ethernet support is disabled ([97f23539f](https://github.com/enjoy-digital/litex/commit/97f23539f), [PR #2453](https://github.com/enjoy-digital/litex/pull/2453)).
