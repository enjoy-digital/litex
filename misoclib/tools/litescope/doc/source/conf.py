# -*- coding: utf-8 -*-
#
# LiteScope documentation build configuration file, created by
...
litescope_version = open(os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'litescope-version.txt'))).read().strip()

# The short X.Y version.
version = litescope_version[:litescope_version.rindex('.')]
# The full version, including alpha/beta/rc tags.
release = litescope_version
...
# of the sidebar.
html_logo = '_static/LiteScope_logo_full.png'


# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = 'litescope.ico'
...
htmlhelp_basename = 'LiteScopedoc'
...
latex_documents = [
  ('index', 'LiteScope.tex', u'LiteScope Documentation',
...
man_pages = [
    ('index', 'litescope', u'LiteScope Documentation',
...
texinfo_documents = [
  ('index', 'LiteScope', u'LiteScope Documentation',
   u'Florent Kermarrec', 'LiteScope', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'LiteScope'
epub_author = u'Florent Kermarrec'
epub_publisher = u'Florent Kermarrec'
epub_copyright = u'2015, LiteScope Contributors'

# The basename for the epub file. It defaults to the project name.
#epub_basename = u'LiteScope'
