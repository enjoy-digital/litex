...
class TestHyperRAM(unittest.TestCase):
    ...
    def test_hyperram_wishbone_classic_adjacent_writes_use_single_command(self):
        command_starts = []
    ...
    def test_hyperram_wishbone_classic_non_adjacent_writes_start_separate_commands(self):
        command_starts = []
