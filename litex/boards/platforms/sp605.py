...
_io = [
    ...
    ("user_led", 0, Pins("D17"), IOStandard("LVCMOS18")),
    ("user_led", 1, Pins("AB4"), IOStandard("LVCMOS18")),
    ("user_led", 2, Pins("D21"), IOStandard("LVCMOS18")),
    ("user_led", 3, Pins("W15"), IOStandard("LVCMOS18")),
