...
def get_csr_header(regions, constants, csr_ordering, csr_base=None, with_csr_base_define=True, with_access_functions=True, with_fields_access_functions=False):
    """
