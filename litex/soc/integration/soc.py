        ...
        if not isinstance(self.cpu, cpu.CPUNone):
            ...
            if hasattr(self.cpu, "dma_bus"):
                ...
                self.dma_bus = SoCBusHandler(
                    ...
                    data_width       = self.bus.data_width if (dma_bus_standard == "wishbone") else # FIXME: Need testing before switching to self.cpu.dma_bus.data_width.
                                       self.cpu.dma_bus.data_width,
